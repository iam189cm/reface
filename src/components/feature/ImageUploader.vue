  ...
  <div class="max-w-2xl mx-auto mobile-padding">
    <div class="glass-effect rounded-3xl p-4 md:p-8 text-center">
      ...
      >
        ...
        <!-- 上传文本 -->
        <h3 class="text-lg md:text-xl font-semibold text-gray-900 mb-2 mobile-title">
          {{ uploadText }}
        </h3>
        <p class="text-sm md:text-base text-gray-600 mb-2 mobile-text-base">
          支持 JPG、PNG、WebP 格式，最大 10MB
        </p>
        <p class="text-xs md:text-sm text-gray-500 mb-4 mobile-text-sm">
          图片将在处理完成后自动删除，保护您的隐私
        </p>
      ...
      <div
        ...
        class="mt-4 text-sm text-red-600 bg-red-50 px-4 py-2 rounded-lg"
      >
        {{ errorMessage }}
      </div>
    </div>
