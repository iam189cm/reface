    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div class="bg-white rounded-xl shadow-sm">
        ...
        <div class="p-6">
          ...
          <div
            v-else-if="userSearchQuery && !isSearching"
          ...
          >
            ...
            >
              <path
                ...
                stroke-linejoin="round"
                stroke-width="2"
                d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.29-1.009-5.824-2.562M15 17H9v-2.25"
              />
            </svg>
            <p>未找到匹配的用户</p>
          </div>
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <p class="text-xs text-gray-500">
                    {{ event.user_email }} • {{ formatTime(event.created_at) }}
                  </p>
                </div>
